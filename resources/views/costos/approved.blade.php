@extends('layouts.app_real', ['body_class' => 'ots', 'title' => 'Cotizaciones aprobadas'])
@section('content')
<div class="row">
  <div class="col-md-12">
    <div class="card form-card">
      <div class="card-header">
        <h4 class="card-title">Órdenes con cotización aprobadas</h4>
      </div>
      <div class="card-body">
...
$(document).ready(function() {
  pendingots = $('.data-table').DataTable({
     processing: true,
     serverSide: true,
     ajax: "{{route('card_cost.list_approved')}}",
     pageLength: 5,
     lengthMenu: [ 5, 25, 50 ],
     columns: [
