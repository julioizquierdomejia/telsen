...
<div class="row">
  <div class="col-md-12">
    <form method="POST" action="{{route('formatos.electrical.store', ['id' => $ot->id])}}" enctype="multipart/form-data">
      ...
      <div class="card form-card">
        <div class="card-header">
          <h4 class="second-title text-danger py-2" style="cursor: pointer" data-toggle="collapse" data-target="#collapseTest">Pruebas de Ingreso</h4>
        </div>
      ...
      <div class="card form-card">
        <div class="card-header">
          <h4 class="second-title text-danger py-2" style="cursor: pointer" data-toggle="collapse" data-target="#collapseTr">Transformador</h4>
        </div>
        <div class="card-body pb-3 pt-0">
          ...
          <table class="table table-tap table-separate text-center table-numbering mb-0" id="table-tap">
            ...
            <tr>
              <td class="p-0" colspan="7">
                <button class="btn btn-dark btn-add-tap-row btn-sm my-1" data-table="tap" type="button">Agregar fila <i class="far ml-1 fa-plus"></i></button>
                <button class="btn btn-secondary btn-clear btn-sm my-1" data-table="tap" type="button">Limpiar <i class="far ml-1 fa-eraser"></i></button>
              </td>
            </tr>
            </tfoot>
          </table>
          ...
          <div class="row">
            ...
            <div class="col-md-12 form-group">
                ...
                <table class="table table-separate text-center table-numbering mb-0 @error('works') is-invalid @enderror" id="table-works">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td class="cell-counter"><span class="number"></span></td>
                      <td>
                        <input type="hidden" name="works[{{$key}}][type]" value="electrical">
                    ...
                    <tr>
                      <td class="cell-counter"><span class="number"></span></td>
                      <td>
                        <input type="hidden" name="works[0][type]" value="electrical">
              ...
              <div class="buttons text-center">
                  <button class="btn btn-dark btn-add-row btn-sm my-1" data-table="works" data-work_type="electrical" type="button">Agregar fila <i class="far ml-1 fa-plus"></i></button>
            ...
            <div class="col-md-12 form-group">
              ...
              <div class="table-responsive">
                <table class="table table-separate text-center table-numbering mb-0 @error('additional_works') is-invalid @enderror" id="table-additional_works">
                  <thead>
                    <tr>
                    <th class="text-center py-1">Item</th>
                    <th class="text-center py-1">Área</th>
                  ...
                  <tbody>
                    @if($additional_works = old('additional_works'))
                    @foreach($additional_works as $key => $item)
                    <tr>
                      <td class="cell-counter"><span class="number"></span></td>
                      <td>
                        <input type="hidden" name="works[{{$key}}][type]" value="add_electrical">
                        <select class="dropdown2 form-control select-area" name="additional_works[{{$key}}][area]" style="width: 100%">
                          <option value="">Seleccionar area</option>
                          @foreach($areas as $area)
                          <option value="{{$area->id}}" {{ old('additional_works.'.$key.'.area', $item['area'] ?? '') == $area->id ? 'selected' : '' }}>{{$area->name}}</option>
                          @endforeach
                        </select>
                      </td>
                      <td>
                      ...
                      <td width="120">
                        <input type="text" class="form-control mt-0 
                        @error('additional_works.'.$key.'.description') is-invalid @enderror"
                         placeholder="Descripción" value="{{old('additional_works.'.$key.'.description', $item['description'])}}" name="additional_works[{{$key}}][description]">
                      </td>
                      <td width="100">
                        <input type="text" class="form-control mt-0 @error('additional_works.'.$key.'.medidas') is-invalid @enderror" placeholder="Medida" value="{{old('additional_works.'.$key.'.medidas', $item['medidas'])}}" name="additional_works[{{$key}}][medidas]">
                      </td>
                      <td width="100">
                        <input type="text" class="form-control mt-0 @error('additional_works.'.$key.'.qty') is-invalid @enderror" placeholder="Cantidad" value="{{old('additional_works.'.$key.'.qty', $item['qty'])}}" name="additional_works[{{$key}}][qty]">
                      </td>
                      <td width="100">
                        <input type="text" class="form-control mt-0 @error('additional_works.'.$key.'.personal') is-invalid @enderror" placeholder="Personal" value="{{old('additional_works.'.$key.'.personal', $item['personal'])}}" name="additional_works[{{$key}}][personal]">
                      </td>
                      <td>
                        <button class="btn btn-secondary btn-remove-row btn-sm my-1" type="button" title="Remover fila"><i class="far fa-trash"></i></button>
                      </td>
                    ...
                    <tr>
                      <td class="cell-counter"><span class="number"></span></td>
                      <td>
                        <input type="hidden" name="works[0][type]" value="add_electrical">
              ...
              <div class="buttons text-center">
                  <button class="btn btn-dark btn-add-row btn-sm my-1" data-table="additional_works" data-work_type="add_electrical" type="button">Agregar fila <i class="far ml-1 fa-plus"></i></button>
              ...
              @error('additional_works')
              <p class="error-message text-danger">{{ $message }}</p>
              @enderror
            </div>
            <div class="col-12 mb-2">
              <label class="col-form-label">Observaciones</label>
              <textarea class="form-control @error('observaciones') is-invalid @enderror" placeholder="" name="observaciones" rows="6">{{old('observaciones')}}</textarea>
              @error('observaciones')
              <p class="error-message text-danger">{{ $message }}</p>
              @enderror
            </div>
