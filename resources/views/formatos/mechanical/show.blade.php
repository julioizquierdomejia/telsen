			...
			<div class="card-body">
				<div class="row">
					...
					<div class="col-md-12 form-group">
						...
						<table class="table table-tap table-separate text-center table-numbering mb-0" id="table-works">
							<thead>
								<tr>
						...
						<div class="table-responsive">
						<table class="table table-tap table-separate text-center table-numbering mb-0" id="table-additional_works">
							<thead>
								<tr>
									<th class="text-center py-1">Item</th>
									<th class="text-center py-1">Área</th>
	      ...
	      <div class="card-body">
	          <div class="gallery">
	            ...
	            <li class="gallery-item col-12 col-md-4 col-xl-3 py-2">
	              <img class="btn p-0" data-toggle="modal" data-target="#galleryModal" src="{{ asset("uploads/ots/$formato->ot_id/mechanical/$file->file") }}" width="250">
