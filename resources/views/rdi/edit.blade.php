  ...
  <div class="col-md-12">
    <div class="card card-user form-card">
      <div class="card-header">
        <h5 class="card-title">Editar RDI de OT-<strong>{{$ot_code}}</strong></h5>
      </div>
      <div class="card-body">
        <form class="form-group" method="POST" action="{{route('rdi.edit', $rdi->id)}}" enctype="multipart/form-data">
          @csrf
          <div class="row">
            ...
            <div class="col-md-3 form-group">
                ...
                <input type="text" class="form-control @error('tiempo_entrega') is-invalid @enderror" min="1" placeholder="Días de entrega" value="{{old('tiempo_entrega', $rdi->tiempo_entrega)}}" title="Días de entrega" data-toggle="tooltip" name='tiempo_entrega' id="tiempo_entrega">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td width="120">
                    <input type="text" class="form-control mt-0
                    @error("works.".$key.".description") is-invalid @enderror"
                    placeholder="Descripción" value="{{$item['description']}}" name="works[{{$key}}][description]">
                  </td>
                  <td width="100">
