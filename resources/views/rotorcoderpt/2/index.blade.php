...
<div class="row">
	<div class="col">
		<a href="{{ route('rotorcoderpt2.create') }}" class="btn btn-primary">Crear Código</a>
	</div>
</div>
<div class="row">
	<div class="col-md-12">
    <div class="card form-card">
      <div class="card-header">
        <h4 class="card-title">Códigos Rodaje Pto 2</h4>
      </div>
      <div class="card-body">
            ...
            <tbody>
            	{{-- @foreach($codes as $code)
                  ...
                  <td>
	                ...
	                <td class="text-right">
	                	<a href=" {{ route('rotorcoderpt2.edit', $code) }} " class="btn btn-warning"><i class="fal fa-edit"></i></a>
	                </td>
	              </tr>
              @endforeach --}}
            </tbody>
